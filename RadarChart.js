...
var RadarChart = {
  ...
  var cfg = {
	...
	var allAxis = (d[0].map(function(i, j){return i.Indicator}));
	console.log(allAxis);
	...
	var axis = g.selectAll(".Indicator")
			.data(allAxis)
			.enter()
			.append("g")
	...
	d.forEach(function(y,x){//
	  ...
	  dataValues.push(dataValues[0]);//new
...
/*if(val.length==2)
{
				...
				button.type="button";
				button.appendChild(document.createTextNode('Would you like to have another view of this data'));
  				var body = document.getElementsByTagName("body")[0];
    			document.body.appendChild(button);

				
//document.write(<button type="button" id="div1"  onClick="another_view();">);
					...
					script1.setAttribute("src","C:/Users/harsh/Documents/ms_project/another_view.js");
					//var body = document.getElementsByTagName("body")[0];
					document.getElementsByTagName("body")[0].appendChild(script1);	
					button.onclick="another_view();";*/
